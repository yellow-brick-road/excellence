...
Project: {path}
Tool: `~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py`

Run:
```bash
python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py {source_dir}
```

Output: `{source_dir}/docs/guidelines/`

Check progress: `python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py {source_dir} --report`
