...
```bash
cd <project> && python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --scan [--extensions 'REGEX']
```
...
```bash
cd <project> && python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --phase all --bg [--extensions 'REGEX']
```
...
```bash
cd <project> && python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --report
```
