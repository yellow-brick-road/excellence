...
cd ~/work/my-project
python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --scan

# Run full pipeline in background
python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --phase all --bg -y

# Check progress
python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --report

# Stop if needed
python3 ~/.kiro/skills/guidelines-generator/scripts/guidelines-generator.py --stop
```
