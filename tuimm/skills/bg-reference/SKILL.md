...
name: bg-reference
description: |
  bg — background execution library at ~/.kiro/skills/bg-reference/scripts/.
...
```
~/.kiro/skills/bg-reference/scripts/bg.py
```
...
- logd (`~/.kiro/skills/logd-reference/scripts/`) — for structured logging and LOGD_UID correlation
