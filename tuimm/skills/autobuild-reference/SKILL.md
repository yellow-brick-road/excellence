...
description: |
  autobuild — task engine at ~/.kiro/skills/autobuild-reference/scripts/ for executing markdown task files via kiro-cli agents.
...
```
~/.kiro/skills/autobuild-reference/scripts/
...
- logd (`~/.kiro/skills/logd-reference/scripts/`) — structured logging
- bg (`~/.kiro/skills/bg-reference/scripts/`) — background execution (--bg/--status/--tail/--stop)
