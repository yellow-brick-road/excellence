...
- If ticket ID: delegate to tuimm_subagent_jira — gather full context following the tuimm-jira-context-gathering skill (parent, links, comments, attachments, not just title and ACs). If the ticket has sub-tasks or linked issues, fetch their full details too (second subagent call)
