...
```bash
python3 ~/.kiro/steering/tuimm/scripts/workspace-cleanup-check.py &
```
...
Delegate to subagents according to their defined function (see `SUBAGENTS.md`). Never use a subagent outside its scope.
