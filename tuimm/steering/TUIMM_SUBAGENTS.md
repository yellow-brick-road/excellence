...
When a Tier 1 agent is spawned as a subagent (e.g., from tuimm_default), it runs with a reduced tool set. See `TUIMM_TOOL_RULES.md § Subagent Runtime Limitations` for the full list.
