...
After committing work on a Jira ticket, set AI usage fields. Use `$jira_set-ai-usage` or let `$dev_solve` handle it automatically. See `TUIMM_AI_USAGE_TRACKING.md`.
