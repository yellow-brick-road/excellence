...
TEMPLATES_DIR = Path(os.path.expanduser("~/.kiro/tuimm/templates/guidelines-generator"))
SKILLS_DIR = Path(os.path.expanduser("~/.kiro/tuimm/skills"))
...
def phase_extract(files: list[FileInfo], repo_root: Path, work_dir: Path,
    ...
    # Run autobuild
    engine = os.path.expanduser("~/.kiro/tuimm/tools/autobuild/engine.py")
    result = subprocess.run(
