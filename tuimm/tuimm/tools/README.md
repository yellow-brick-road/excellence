...
python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --phase all --bg -y

# 3. Check progress
python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --report

# 4. Stop if needed
python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --stop
```
...
python3 ~/.kiro/tuimm/tools/autobuild/engine.py --tasks .plan/my-feature/tasks/

# Check status
python3 ~/.kiro/tuimm/tools/autobuild/engine.py --status
```
