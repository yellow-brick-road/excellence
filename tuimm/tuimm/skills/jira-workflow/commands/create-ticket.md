...
2. If a reference ticket is provided (URL, key, or "related to X"), gather its full context following the jira-context-gathering skill — parent, links, comments, attachments. If the ticket has sub-tasks or linked issues, fetch their full details too (second subagent call). Present a summary to the user before proceeding
