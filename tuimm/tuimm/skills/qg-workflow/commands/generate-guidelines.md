...
```bash
cd <project> && python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --scan [--extensions 'REGEX']
```
...
```bash
cd <project> && python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --phase all --bg [--extensions 'REGEX']
```
...
```bash
cd <project> && python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py --report
```
