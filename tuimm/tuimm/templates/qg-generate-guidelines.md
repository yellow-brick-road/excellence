...
Project: {path}
Tool: `~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py`

Run:
```bash
python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py {source_dir}
```

Output: `{source_dir}/docs/guidelines/`

Check progress: `python3 ~/.kiro/tuimm/tools/guidelines-generator/guidelines-generator.py {source_dir} --report`
