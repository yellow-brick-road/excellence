...
Each agent has commands: structured, step-by-step workflows for specific tasks. 35 commands across 11 domains.
...
| **Excellence Agents** | 9 specialist agents + 10 tool subagents + 35 commands + 11 skills | ✅ Built |
