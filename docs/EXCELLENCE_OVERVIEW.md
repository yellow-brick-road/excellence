...
Each agent has commands: structured, step-by-step workflows for specific tasks. 36 commands across 11 domains.
...
| **Excellence Agents** | 9 specialist agents + 10 tool subagents + 36 commands + 14 skills | ✅ Built |
